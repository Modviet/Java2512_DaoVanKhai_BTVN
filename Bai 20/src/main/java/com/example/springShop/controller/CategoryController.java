...
public class CategoryController {
    ...
    public String createCategory(
        ...
        try {
            ...
            redirect.addFlashAttribute(FLASH_SUCCESS,"Tao danh muc thanh cong");
        } catch (Exception e){
    ...
    public String updateCategory(
        ...
        try {
            ...
            redirect.addFlashAttribute(FLASH_SUCCESS,"Cap nhat danh muc thanh cong");
        } catch (Exception e){
            redirect.addFlashAttribute(FLASH_ERROR,e.getMessage());
        }
        return REDIRECT_CATEGORIES;
    ...
    public String deleteCategory(@RequestParam("id") Integer id, RedirectAttributes redirect){
        try {
            ...
            redirect.addFlashAttribute(FLASH_SUCCESS,"Da xoa danh muc");
        } catch (Exception e){
            redirect.addFlashAttribute(FLASH_ERROR,e.getMessage());
        }
        return REDIRECT_CATEGORIES;
