...
public class UserController {
    ...
    public String createUser(
        ...
        try {
            ...
            redirect.addFlashAttribute(FLASH_SUCCESS,"Tao nguoi dung thanh cong");
    ...
    public String updateUser(
        ...
        try {
            ...
            redirect.addFlashAttribute(FLASH_SUCCESS,"Cap nhat nguoi dung thanh cong");
            return REDIRECT_USERS;
        } catch (Exception e){
            redirect.addFlashAttribute(FLASH_ERROR,e.getMessage());
    ...
    public String deleteUser(@RequestParam("id") Integer id , RedirectAttributes redirect){
        try {
            ...
            redirect.addFlashAttribute(FLASH_SUCCESS,"Da xoa nguoi dung");
        } catch (Exception e){
            redirect.addFlashAttribute(FLASH_ERROR,e.getMessage());
        }
        return REDIRECT_USERS;
